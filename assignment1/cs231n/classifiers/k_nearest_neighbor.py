...
class KNearestNeighbor(object):
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in range(num_test):
            for j in range(num_train):
                ...
                # Link to knn.ipynb In[6]
                # Simply apply the l2 distance methods
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            # Link to knn.ipynb In[8]
            # np.argsort(x)[0:k] will sort out k largest number
            ...
            # np.bincount() will find out the most common element in the list
